...
class CoursController extends Controller
{
        ...
        public function index(Request $request)
    {
        ...
        if ($request->filled('id_filiere') && $request->input('id_filiere') !== 'Toutes') {
            $query->where(function($q) use ($request) {
                ...
                // Ou vérifier directement sur la colonne "niveau" du cours (ton architecture)
    ...
    // (La fonction show reste identique...)

    public function recommandes(Request $request)
    {
        $user = $request->user();

        $coursInscrits = \Illuminate\Support\Facades\DB::table('inscription_cours')
